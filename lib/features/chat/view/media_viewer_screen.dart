...
class _MediaViewerScreenState extends State<MediaViewerScreen> {
  ...
  Future _loadVideo() async {
    final ChatProvider chatController = Provider.of<ChatProvider>(context, listen: false);


    if(_fromNetwork && (widget.serverMedia?.isNotEmpty ?? false)){
      if(chatController.isVideoExtension(widget.serverMedia?[currentIndex].filename ?? '')){
        controller =  VideoPlayerController.networkUrl(Uri.parse('${widget.serverMedia![currentIndex].filename}'));
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (context, index)=> Column(children: [
              ...
              Padding(
                ...
                child: Row( children: [
                  Expanded(child: Text(
                    _extractFileName(
                      _fromNetwork ?
                      widget.serverMedia![currentIndex].filename :
              ...
              _fromNetwork ? chatController.isVideoExtension(widget.serverMedia![currentIndex].filename ?? '') && chewController != null ? Flexible(
                child: Center(child: Chewie(controller: chewController!)),
              ) : Expanded(child: CustomImage(
                fit: BoxFit.contain,
                image: '${AppConstants.baseUrl}/storage/app/public/chatting/${widget.serverMedia?[currentIndex].filename}' ?? '',
              )) : chatController.isVideoExtension(widget.localMedia![currentIndex].path) && chewController != null ? Flexible(
                child: Center(child: Chewie(controller: chewController!)),
              ) : Expanded(
                child: Image.file(File('${AppConstants.baseUrl}/storage/app/public/chatting/${widget.serverMedia?[currentIndex].filename}')),
              ),
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  InkWell(
                    ...
                    '${AppConstants.baseUrl}/storage/app/public/chatting/${widget.serverMedia?[currentIndex].filename}' :
                    '${AppConstants.baseUrl}/storage/app/public/chatting/${widget.serverMedia?[currentIndex].filename}',),
