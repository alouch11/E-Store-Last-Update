            ...
            child: Padding(padding:  const EdgeInsets.symmetric(
              ...
              child: TextFormField(controller: searchController,
                ...
                onFieldSubmitted: (val){
                  Provider.of<ChatProvider>(context, listen: false).searchUser(context, searchController.text.trim());
                  ...
                  suffixIcon: searchController.text.isNotEmpty? InkWell(
                      onTap: (){
                        setState(() {
                          ...
                          Provider.of<ChatProvider>(context, listen: false).getUserList(context, 1);
                        });
