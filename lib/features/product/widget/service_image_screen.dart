...
class ServiceImagesScreen extends StatefulWidget {
  final String? title;
  final List<String>? imageList;
  const ServiceImagesScreen({super.key, required this.title, required this.imageList});

  @override
  ServiceImagesScreenState createState() => ServiceImagesScreenState();
}

class ServiceImagesScreenState extends State<ServiceImagesScreen> {
  int? pageIndex;
  ...
  void initState() {
    super.initState();
    pageIndex = Provider.of<SaleProvider>(context, listen: false).imageSliderIndex;
              ...
              PhotoViewGallery.builder(
                ...
                builder: (BuildContext context, int index) {
                  return PhotoViewGalleryPageOptions(
                    imageProvider: NetworkImage('${Provider.of<SplashProvider>(context,listen: false).baseUrls!.serviceImagesUrl}/${widget.imageList![index]}'),
