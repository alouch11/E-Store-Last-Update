           ...
           // labelText : widget.showLabelText? widget.labelText?? widget.hintText : null,
            ...
            prefixIcon: widget.prefixIcon != null ? InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset(height: 20, width: 20, widget.prefixIcon!, color: widget.prefixColor ?? Theme.of(context).primaryColor.withOpacity(.4)),
                )),
            ) :
                  ...
                  child: Row(children: [
                       /*CodePickerWidget(
                        padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
                          ...
                          barrierColor: Provider.of<ThemeProvider>(context).darkTheme ? Colors.black.withOpacity(0.5) : null,
